    ...
    <div class="flex flex-1 flex-col justify-center px-4 py-12 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
        <div class="mx-auto w-full max-w-sm lg:w-96">
            <div>
                ...
                <h2 class="mt-8 text-2xl/9 font-roboto-regular tracking-tight text-gray-600">Register a free account</h2>
                <p class="mt-2 text-sm/6 text-gray-500">
                    Already a member?
                    <a href="/login" class="font-semibold text-orange-600 hover:text-orange-500">Log in to your account</a>.
                </p>
            </div>
            ...
            <div class="mt-10">
                <div>
                    <form method="POST" action="{{ route('register') }}" class="space-y-6">
                        ...
                        <div>
                            <label for="password" class="block text-sm/6 font-roboto-regular text-gray-900">Confirm Password</label>
                            <div class="mt-2">
                                <input type="password" name="password_confirmation" id="password-confirm" autocomplete="new-password" required class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-orange-600 sm:text-sm/6 @error('password') outline-red-600 @else outline-gray-300 @enderror">
                            </div>
                        </div>

                        <div>
                            <button type="submit" class="flex w-full justify-center rounded-md bg-orange-600 px-3 py-1.5 text-sm/6 font-roboto-regular text-white shadow-sm hover:bg-orange-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-orange-600">Sign up</button>
                        </div>
                    </form>
                </div>
